...
if __name__ == "__main__":
    ...
    data = [
        ...
        ("Untuk balik nama sertifikat tanah, KTP pemilik lama harus masih aktif atau nggak masalah kalau sudah pindah?", "semi-formal", "Ya, KTP pemilik lama harus aktif, tapi kalau sudah pindah, kamu bisa memberikan surat keterangan domisili atau pernyataan agar datanya tetap nyambung di BPN.", "dog"),
